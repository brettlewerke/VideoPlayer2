...
export const SCHEMA_V1: DatabaseSchema = {
  ...
  tables: [
    ...
    },
    {
      ...
      columns: [
        { name: 'id', type: 'TEXT', primaryKey: true },
        { name: 'content_key', type: 'TEXT', nullable: false },
        { name: 'position_seconds', type: 'REAL', nullable: false, defaultValue: 0 },
        { name: 'duration_seconds', type: 'REAL', nullable: false, defaultValue: 0 },
        { name: 'completed', type: 'INTEGER', nullable: false, defaultValue: 0 },
        { name: 'last_played_at', type: 'INTEGER', nullable: false },
        { name: 'created_at', type: 'INTEGER', nullable: false },
        { name: 'updated_at', type: 'INTEGER', nullable: false },
      ],
      constraints: ['UNIQUE(content_key)'],
    },
    {
      name: 'settings',
      columns: [
  ...
  indexes: [
    ...
    { name: 'idx_progress_content_key', table: 'progress', columns: ['content_key'] },
    { name: 'idx_progress_completed', table: 'progress', columns: ['completed'] },
    { name: 'idx_progress_last_played', table: 'progress', columns: ['last_played_at'] },
